...
```
GET /api/categorias, GET /api/categorias/activas, GET /api/categorias/raices, GET /api/categorias/{id}/subcategorias, POST /api/categorias, PUT /api/categorias/{id}, DELETE /api/categorias/{id}
```
...
| Remoto (Render) | https://ms-categorias-7uxg.onrender.com/swagger-ui.html |
...
```
https://ms-gateway-ndke.onrender.com/api/categorias
```
...
Desplegado en **Render**: https://ms-categorias-7uxg.onrender.com
